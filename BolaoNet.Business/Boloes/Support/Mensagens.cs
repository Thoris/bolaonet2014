...
{
    [Serializable]
    public class Mensagens : Model.Boloes.Mensagem, IBusinessMensagens
    {
        #region Variables

        private string _currentLogin = null;
        private Dao.Boloes.IDaoMensagens _daoBase = null;

        #endregion

        #region Constructors/Destructors
        public Mensagens(string currentLogin)
        {
            _currentLogin = currentLogin;
            _daoBase = new Dao.Boloes.SQLSupport.Mensagem();
        }

        public Mensagens(string currentLogin, Dao.Boloes.IDaoMensagens daoBase)
        {
            if (daoBase == null)
        ...
        public bool Load()
        {
            ...
            this.Copy((Model.Boloes.Mensagem)result);
        ...
        #region IBusinessMensagens Members
        ...
        public bool AddMessage()
        {
            ...
            bool result = _daoBase.AddMessage(_currentLogin, this, out errorNumber, out errorDescription);
