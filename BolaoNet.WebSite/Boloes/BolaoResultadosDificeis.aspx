<%@Page Language="C#" ValidateRequest="false"MasterPageFile="~/Shared/Site.Master" AutoEventWireup="true" CodeBehind="BolaoResultadosDificeis.aspx.cs" Inherits="BolaoNet.WebSite.Boloes.BolaoResultadosDificeis"  %>
    ...
    <table class="adminTable">
        <tr>
            <td class="welcome-message" colspan="2">
                <asp:Label ID="lblTitle" runat="server">Acertos de resultados difíceis</asp:Label>
            </td>
            <td class="adminTools">
