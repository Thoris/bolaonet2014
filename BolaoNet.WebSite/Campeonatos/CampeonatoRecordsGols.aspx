<%@ Page Language="C#" MasterPageFile="~/Shared/Site.Master" AutoEventWireup="true" CodeBehind="CampeonatoRecordsGols.aspx.cs" Inherits="BolaoNet.WebSite.Campeonatos.CampeonatoRecordsGols"  %>
    ...
    <table class="adminTable">
        <tr>
            <td class="welcome-message" colspan="2">
                <asp:Label ID="lblTitle" runat="server">Records de gols do campeonato</asp:Label>
            </td>
