IF EXISTS (SELECT * FROM sysobjects WHERE type = 'P' AND name = 'CreateBolaoCopaDoMundo2010')
BEGIN
	DROP  Procedure  CreateBolaoCopaDoMundo2010
END
GO



CREATE PROCEDURE [dbo].[CreateBolaoCopaDoMundo2010]
AS
BEGIN
	...
	IF (NOT EXISTS (SELECT * FROM Boloes WHERE Nome = @NomeBolao))
		INSERT INTO Boloes
		 ...
		 VALUES
			(@NomeBolao, @NomeCampeonato, 0, 10.000, '2010-06-10', 1, @CurrentLogin, GetDate(), @CurrentLogin, GetDate(), 0)
